...
export default async (req: Request, res: Response) => {
    ...
    const userInfo: User = {
        ...
        bio: "Hello, world!",
        description:
            "Ut est laboris cupidatat anim quis consectetur enim aute. Nisi et qui labore magna ullamco enim consectetur nulla reprehenderit incididunt. Laborum aute anim tempor exercitation consectetur minim labore esse consequat cupidatat nisi ad tempor incididunt.",
        phone: phone,
        location: "Sousse",
